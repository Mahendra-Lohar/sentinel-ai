      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <Box sx={{ width: 'min(420px, 100%)' }}>
          ...
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="h5" fontWeight={900} sx={{ mb: 0.5 }}>Welcome back</Typography>
            <Typography variant="body2" color="text.secondary">Sign in to Sentinel AI</Typography>
          </Box>
            ...
            <CardContent sx={{ p: 3.5 }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <Button
                  ...
                  disabled={loading} endIcon={<ArrowForward />}
                  sx={{ py: 1.4 }}
                >
              ...
              <Box sx={{ textAlign: 'center' }}>
                <Typography variant="body2" color="text.secondary">
                  ...
                  <Link to="/register" style={{ color: '#16c7a2', fontWeight: 700 }}>
                    Create account
                  </Link>
                </Typography>
              </Box>
          ...
          <Box sx={{ textAlign: 'center', mt: 2 }}>
            <Chip
              label="Powered by AEGIS — Autonomous Evidence Gathering & Intelligent Synthesis"
              size="small"
              sx={{ background: 'rgba(22,199,162,0.08)', color: 'text.secondary', fontSize: '0.68rem', border: '1px solid rgba(22,199,162,0.15)' }}
            />
          </Box>
        </Box>
      </motion.div>
